...
const ContactUs = ({widthMobile}) => {
  
  return (
    <button className={`${widthMobile ? 'max-w-[345px] min-w-[260px]' : 'w-[140px]'} group relative flex h-[51px] items-center justify-center overflow-hidden rounded-full border border-white font-light text-light transition-colors duration-300 hover:bg-light`}>
